...
class Booking extends CI_Controller
{
  ...
  public function tambahBooking()
  {
    ...
    $isi = [
      ...
      'tgl_booking' => date('Y-m-d H:i:s'), //2022-10-04 16:25:30
      'image' => $d->image,
      'penulis' => $d->pengarang,
      'penerbit' => $d->penerbit,
  ...
  public function bookingSelesai($where)
  {
    ...
    $tglsekarang = date('Y-m-d'); //2022-10-11
    $isibooking = [
      'id_booking' => $this->ModelBooking->kodeOtomatis('booking', 'id_booking'),
      'tgl_booking' => date('Y-m-d H:i:s'), //2022-10-11 20:00:00
      'batas_ambil' => date('Y-m-d', strtotime('+2 days', strtotime($tglsekarang))), //2022-10-13
      'id_user' => $where
    ];
