...
class Pinjam extends CI_Controller
{
  ...
  public function pinjamAct()
  {
    ...
    $tglsekarang = date('Y-m-d'); //2022-10-18
  ...
  public function ubahStatus()
  {
    ...
    $this->db->query("UPDATE pinjam, detail_pinjam SET pinjam.status='$status', pinjam.tgl_kembali='$tgl' WHERE detail_pinjam.id_buku='$id_buku' AND pinjam.no_pinjam='$no_pinjam'");
    //update stok dan dipinjam pada tabel buku
    $this->db->query("UPDATE buku, detail_pinjam SET buku.dipinjam=buku.dipinjam, buku.stok=buku.stok+1 WHERE buku.id=detail_pinjam.id_buku");
